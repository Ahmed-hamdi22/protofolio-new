            ...
            <div className="project">
              ...
              <div className="project_information">
                ...
                <div>
                  ...
                  <a
                    href="https://github.com/aman-638/store.rockstartgames.com-Frontend-Clone00"
                    target="_blank"
                    rel="noreferrer"
                  >
            ...
            <div className="project">
              ...
              <div className="project_information">
                ...
                <div>
                  ...
                  <a
                    href="https://github.com/Shreyasgkhakal100/Weather-App00"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <span type="button" className="btns onbt">
          ...
          <div className="projects_container" data-aos="fade-right">
            <div className="project">
              ...
              <div className="project_information">
                ...
                <div>
                  <a
                    href="https://www.npmjs.com/package/apijs-mongo 00"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <span type="button" className="btns onbt onbt">
                  ...
                  <a
                    href="https://github.com/Shreyasgkhakal100/API.JS-Mongo00"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <span type="button" className="btns onbt">
          ...
          <div className="projects_container" data-aos="fade-right">
            <div className="project">
              ...
              <div className="project_information">
                ...
                <div>
                  <a
                    href="https://drive-system.herokuapp.com/user/ 00"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <span type="button" className="btns onbt onbt">
                  ...
                  <a
                    href="https://github.com/imbickydutta/file-system-backend00"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <span type="button" className="btns onbt">
            ...
            <div className="project">
              ...
              <div className="project_information">
                ...
                <div>
                  ...
                  <a
                    href="https://github.com/Shreyasgkhakal100/uniqlo-backend-2 00"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <span type="button" className="btns onbt">
          ...
          <div className="projects_container" data-aos="fade-right">
            <div className="project">
              <div className="project_videocontainer">
                <div>
                  <img
                    src="https://i.ibb.co/KVBGkdy/FFD69103-C304-42-E8-BCCD-8836-AAEFEA9-C.jpg 00"
                    alt="PulsePlus-Clone"
                  />
                </div>
              </div>
              <div className="project_information">
                ...
                <div>
                  <a
                    href="https://pulseplus-clone.netlify.app/landing_page.html00 "
                    target="_blank"
                    rel="noreferrer"
                  >
                    <span type="button" className="btns onbt onbt">
                  ...
                  <a
                    href="https://github.com/Shreyasgkhakal100/www.pulseplus.in-Clone 00"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <span type="button" className="btns onbt">
